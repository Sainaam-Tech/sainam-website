...
<div class="flex items-center gap-4 my-6 p-6 rounded-2xl bg-teal-50 dark:bg-teal-900/20 border border-teal-100 dark:border-teal-800">
  ...
  <div>
    ...
    <a href="/downloads/lr-mitra-v1.7.apk" download class="inline-flex items-center gap-2 bg-teal-700 text-white text-sm font-medium px-5 py-2.5 rounded-xl hover:bg-teal-800 transition-colors">
